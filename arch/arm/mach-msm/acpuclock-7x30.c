...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 0, MAX_AXI_KHZ, AXI, 1, 0,  61440000,  850, VDD_RAW(850) },
	...
	{ 1, 1200000, PLL_2, 3, 0, 192000000, 1150, VDD_RAW(1150), &pll2_tbl[2]},
	{ 1, 1305600, PLL_2, 3, 0, 192000000, 1175, VDD_RAW(1175), &pll2_tbl[3]},
	...
	{ 1, 1708800, PLL_2, 3, 0, 192000000, 1375, VDD_RAW(1375) ,&pll2_tbl[8]},
	{ 1, 1804800, PLL_2, 3, 0, 192000000, 1425, VDD_RAW(1425) ,&pll2_tbl[9]},
	{ 0 }
#else
